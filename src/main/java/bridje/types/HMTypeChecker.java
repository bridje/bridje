...
import bridje.analyser.Expr.BoolExpr;
import bridje.analyser.Expr.StringExpr;
...
public class HMTypeChecker {
    ...
    private HMTypeChecker(TypeMapping mapping) {
    ...
    public static Expr<Type> typeExpr(Expr<Void> expr) {
        return new HMTypeChecker(TypeMapping.EMPTY).typeExpr0(LocalTypeEnv.EMPTY_TYPE_ENV, expr);
    }
