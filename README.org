...
variants with a =case= expression as you would with any other variant. Bridje
provides an =:Ok= variant as part of the core library, but you'll want something
more descriptive for your error cases.
