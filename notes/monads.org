...
- implementation of async within Graal
- can we give transducers a more loop-recur feel?

Fitting for (currently) line 1000 - maybe we need to think async first, then effects/objects might be relatively straightforward.
what are the primitives?
co-routines seem to be pretty fundamental.
